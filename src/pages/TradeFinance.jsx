...
const calculateIssuanceFee = (amount, product, currency) => {
  // Initialize fee to zero
  let fee = 0;
  ...
  // Calculate fee based on product type
  switch (product) {
...
const calculateProcessingFee = (amount, product, currency) => {
  let fee = 0;
  // Determine currency symbol
  let currencySymbol = "$";
  if (currency === "EUR") currencySymbol = "€";
  ...
  switch (product) {
    case "letter_of_credit":
      fee = Math.min(500, Math.max(100, amount * 0.001));
      break;
    case "import_finance":
      fee = Math.min(600, Math.max(150, amount * 0.0012));
      break;
    case "export_finance":
      fee = Math.min(400, Math.max(100, amount * 0.0008));
      break;
    case "shipping_guarantee":
      fee = 100;
      break;
    case "bank_guarantee":
      fee = Math.min(450, Math.max(150, amount * 0.001));
      break;
    default:
      fee = 100;
  }
...
const calculateCommissionRate = (product, tenor) => {
  let baseRate = 0;
...
const calculateCommission = (amount, product, tenor, currency) => {
...
const calculateTotalFees = (amount, product, tenor, currency) => {
  let issuanceFee = 0;
  switch (product) {
    case "letter_of_credit":
...
const calculateFeesPercentage = (amount, product, tenor) => {
  let issuanceFee = 0;
  switch (product) {
    case "letter_of_credit":
      issuanceFee = Math.max(200, amount * 0.0025);
...
const TradeFinance = () => {
  ...
  const [productType, setProductType] = useState("letter_of_credit");
  const [tenor, setTenor] = useState(90);
  const [importerCountry, setImporterCountry] = useState("UAE");
  const [exporterCountry, setExporterCountry] = useState("Malaysia");
  const [commodityType, setCommodityType] = useState("consumer_goods");
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="col-span-2">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    structures based on Islamic contracts such  (cost-plus), Wakala (agency), and Musharaka (partnership),
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        Unlike conventional LCs which involve interest, our Islamic LCs are structured using permissible contracts such  (agency) 
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <Card className="bg-teal-50">
                        ...
                        <CardContent>
                          <p className="text-sm text-gray-700">
                            The bank acts  agent (Wakil) for the importer, handling the LC process for a fixed agency fee 
                    ...
                    <div className="bg-teal-50 rounded-lg p-6">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-md p-4 border border-teal-100">
                          ...
                          <p className="text-sm text-gray-700">
                            All fees are structured  service charges rather than interest-based fees, ensuring full Shariah compliance. 
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent>
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-700">
                          ...
                          <li><strong>Contractual structures:</strong> Uses Islamic contracts such  (cost-plus), Wakala (agency), and Musharaka (partnership) instead of conventional loan agreements.</li>
                        </ul>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        ...
                        <ol className="list-decimal pl-5 mt-2 space-y-2 text-gray-700">
                          <li>
                            <strong>Wakala (Agency) LC:</strong> The bank acts  agent (Wakil) for the importer, handling the LC process for a fixed agency fee rather than charging interest. The importer provides the bank with funds to pay the exporter, or the bank may provide a separate Murabaha facility for this purpose.
                          </li>
                          <li>
                        ...
                        <p className="text-gray-700 mt-2">
                          In all cases, the bank's fees are structured  service charges or legitimate profit shares rather than interest, ensuring Shariah compliance.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-10">
                      ...
                      <AccordionContent>
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-700">
                          <li>
                            <strong>Matching currency approach:</strong> Structuring the transaction in the same currency  underlying trade contract to eliminate exchange risk.
                          </li>
                          <li>
