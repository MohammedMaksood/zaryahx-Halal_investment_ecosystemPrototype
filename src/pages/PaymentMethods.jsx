...
// CardPaymentMethod: { id, name, type: 'card', lastDigits, expiryDate, isDefault }
// UpiPaymentMethod: { id, name, type: 'upi', upiId, isDefault }
// CryptoPaymentMethod: { id, name, type: 'crypto', walletAddress, cryptoType, isDefault }
