...
const MusharakaPartnership = () => {
  // Tab state
  const [activeTab, setActiveTab] = useState('overview');
  
  // Calculator state
  const [totalCapital, setTotalCapital] = useState(1000000);
  const [yourContribution, setYourContribution] = useState(400000);
  const [bankContribution, setBankContribution] = useState(600000);
  const [profitSharingRatio, setProfitSharingRatio] = useState(40);
  const [projectDuration, setProjectDuration] = useState(5);
  const [expectedReturn, setExpectedReturn] = useState(15);
  const [diminishing, setDiminishing] = useState(false);
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        ...
                        <p className="text-gray-700 mt-2">
                          The business must be Shariah-compliant, meaning it cannot involve prohibited activities such -based financial services, alcohol, pork products, gambling, or adult entertainment.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
