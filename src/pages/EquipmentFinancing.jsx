...
const EquipmentFinancing = () => {
  ...
  // Calculator state
  const [equipmentValue, setEquipmentValue] = useState(50000);
  const [downPayment, setDownPayment] = useState(10000);
  const [financingTerm, setFinancingTerm] = useState(36);
  const [financingType, setFinancingType] = useState("ijara");
  const [equipmentType, setEquipmentType] = useState("industrial");
                        ...
                        <AccordionContent className="text-gray-700">
                          ...
                          <ul className="list-disc pl-5 mt-2 space-y-1">
                            ...
                            <ul className="list-circle pl-5 mt-1 mb-2 space-y-1">
                              <li>Receive the equipment  gift (hibah) upon completion of all payments</li>
                            ...
                            <li><span className="font-medium">Murabaha:</span> You already own the equipment,  is a purchase arrangement with deferred payments.</li>
                          </ul>
