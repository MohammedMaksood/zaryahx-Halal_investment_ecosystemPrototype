                    ...
                    {showResults && (
                      <div className="mt-8 p-6 bg-white rounded-lg border border-green-200 animate-in fade-in slide-in-from-bottom-5 duration-500">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-3">
                              <div className="flex justify-between items-center p-2 border-b border-green-100">
                                ...
                                <span className="font-medium">${monthlyPayment.toLocaleString(undefined, { minimumFractionDigits, maximumFractionDigits: 2 })}</span>
                              </div>
                              <div className="flex justify-between items-center p-2 border-b border-green-100">
                                <span className="text-sm">Monthly Profit Component:</span>
                                <span className="font-medium">${(totalProfit / term).toLocaleString(undefined, { minimumFractionDigits, maximumFractionDigits: 2 })}</span>
                              </div>
                            </div>
                            <div className="space-y-3">
                              <div className="flex justify-between items-center p-2 border-b border-green-100">
                                <span className="text-sm">Monthly Principal Component:</span>
                                <span className="font-medium">${(financedAmount / term).toLocaleString(undefined, { minimumFractionDigits, maximumFractionDigits: 2 })}</span>
                              </div>
                              <div className="flex justify-between items-center p-2 border-b border-green-100">
                        ...
                        <div className="mt-6 p-4 bg-green-50 rounded-lg text-center">
                          ...
                          <div className="text-3xl font-bold text-green-700">${monthlyPayment.toLocaleString(undefined, { minimumFractionDigits, maximumFractionDigits: 2 })}</div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-4 bg-white rounded-lg border border-green-100">
                        ...
                        <p className="text-sm text-black/70">
                          ...
                          profit amount  gesture of goodwill (hibah), though this is not contractually guaranteed. The exact terms
                      ...
                      <div className="p-4 bg-white rounded-lg border border-green-100">
                        ...
                        <p className="text-sm text-black/70">
                          ...
                          compounding interest on late payments. However, to discourage late payments, we may require a donation to charity
                           form of compensation. This amount does not benefit the bank and is used solely for charitable purposes.
                        </p>
                      </div>
