 ...
 * @property {boolean} isBookmarked - Whether the message is bookmarked
 */
 ...
 * @property {string} timestamp - When the session was created
 * @property {Array<Message>} messages - Messages in this session
 */
              ...
              <div className="p-4 border-t border-white/10">
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-white/50">Zaryah Member</div>
                  </div>
