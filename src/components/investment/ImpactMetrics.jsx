 ...
 * @property {number} weight - Weight of this metric in overall score
 * @property {string} category - Category (environmental, social, governance)
 */

/**
 * @typedef {Object} InvestmentData
 * @property {number} financialReturn - Financial return percentage
 * @property {number} impactScore - Impact score from 0-100
 * @property {number} combinedScore - Combined score
 * @property {Array<ImpactMetric>} metrics - Array of impact metrics
 * @property {Array<Object>} historicalData - Historical performance data
 */
...
const ImpactMetrics = ({ 
  ...
  const calculateCombinedScore = (financial, impact) => {
