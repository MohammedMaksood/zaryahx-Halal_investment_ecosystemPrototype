...
export function usePortfolio() {
  ...
  // processBuyTransaction = (stock: StockHolding, details: TransactionDetails)
  const processBuyTransaction = (stock, details) => {
  ...
  // processSellTransaction = (stock: StockHolding, details: TransactionDetails)
  const processSellTransaction = (stock, details) => {
  ...
  // processTransaction = (stock: StockHolding, details: TransactionDetails)
  const processTransaction = (stock, details) => {
    if (details.type === 'buy') {
