...
interface AssetValues {
  ...
  goldOwned: number;
  goldLent: number;
  goldOwnedWeight: number;
  goldLentWeight: number;
  goldPrice: number;
  
  // Silver assets
  silverOwned: number;
  silverLent: number;
  silverOwnedWeight: number;
  silverLentWeight: number;
  silverPrice: number;
  
  // Cash assets
  cashInHand: number;
  foreignCurrency: number;
  savingsForGoals: number;
  savingsInPostOffice: number;
  moneyLent: number;
  insuranceSavings: number;
  outstandingLoanToOthers: number;
  goldSilverSavings: number;
  partnershipInvestments: number;
  sharesAndBonds: number;
  monetaryInstruments: number;
  otherSavedAmounts: number;
  providentFundLoan: number;
  advanceAmounts: number;
  
  // Business assets
  rawMaterials: number;
  preparedGoods: number;
  stockedGoods: number;
  receivables: number;
  profitFromShares: number;
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-amber-50">
                    <td className="py-3 px-4">Whatever amount of gold I currently have, its weight in grams, regardless of how it was obtained or for what purpose it is kept</td>
                    <td className="py-3 px-4">
                      <div className="relative">
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4">Whatever amount of silver I currently have, its weight in grams, regardless of how it was obtained or for what purpose it is kept</td>
                    <td className="py-3 px-4">
                      <div className="relative">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-black/50">g</span>
                        <Input
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="bg-white p-3 shadow-lg border border-purple-200">
                    <p className="max-w-xs text-sm">Enter any Zakat amount that was due in previous years but has not been paid yet.</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
              ...
              {isEligible ? (
                ...
                <div className="space-y-4">
                  ...
                  <Alert className="bg-blue-50 border-blue-200 text-blue-800">
                    ...
                    <AlertTitle>Important Note</AlertTitle>
                    <AlertDescription>
                      While you may not be eligible for Zakat based on the Nisab threshold, consider voluntary charity (Sadaqah) as a means of purifying your wealth and helping those in need.
                    </AlertDescription>
                  </Alert>
                </div>
              )}
