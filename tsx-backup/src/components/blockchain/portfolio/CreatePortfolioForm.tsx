...
import { CreatePortfolioParams } from '@/blockchain/services/CommunityPortfolioService';

interface CreatePortfolioFormProps {
  onSubmit: (params: CreatePortfolioParams) => Promise<void>;
  isLoading: boolean;
}
...
const CreatePortfolioForm: React.FC<CreatePortfolioFormProps> = ({ onSubmit, isLoading }) => {
  const [formData, setFormData] = useState<CreatePortfolioParams>({
    name: '',
    description: '',
    location: '',
    impactCategory: '',
