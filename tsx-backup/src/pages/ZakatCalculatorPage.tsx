            ...
            <div className="mt-12 p-6 bg-secondary/30 rounded-lg">
              ...
              <div className="space-y-4 text-sm">
                ...
                <p>
                  ...
                  2.5% (one-fortieth) of the remaining total should be calculated as Zakat.
                </p>
                <p>
                  <strong>Debts and Liabilities:</strong> Only short-term or current liabilities are allowed to be deducted.
                </p>
                <p>
                  <strong>Important Note:</strong> This calculator is provided as a guide. For specific rulings related to your 
