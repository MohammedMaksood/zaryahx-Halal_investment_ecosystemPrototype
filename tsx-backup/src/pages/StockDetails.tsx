...
import { usePortfolioContext, StockPurchaseDetails } from '@/contexts/PortfolioContext';
...
const StockDetails = () => {
  ...
  const calculateOrderCost = (): number => {
  ...
  const handlePlaceOrder = () => {
    ...
    if (orderType === 'buy') {
      ...
      addPendingTransaction({
        type: 'purchase',
        amount: orderCost,
        details: `Purchased ${shares} shares of ${stockData?.symbol} at $${stockData?.price.toFixed(2)} per share`,
        status: 'completed'
      });
