...
const IjaraLeasing: React.FC = () => {
  // State for calculator
  const [assetValue, setAssetValue] = useState<number>(250000);
  const [assetType, setAssetType] = useState<string>("property");
  const [leaseTerm, setLeaseTerm] = useState<number>(60);
  const [rentalRate, setRentalRate] = useState<number>(4.5);
  const [includesPurchaseOption, setIncludesPurchaseOption] = useState<boolean>(true);
                    ...
                    {showResults && (
                      <div className="mt-8 p-6 bg-white rounded-lg border border-blue-200 animate-in fade-in slide-in-from-bottom-5 duration-500">
                        ...
                        <div className="mt-6 p-4 bg-blue-50 rounded-lg text-center">
                          ...
                          <div className="text-3xl font-bold text-blue-700">${monthlyRental.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-4 bg-white rounded-lg border border-blue-100">
                        ...
                        <p className="text-sm text-black/70">
                          ...
                          on behalf of the lessor for a fee or as part of the rental payments. The specific responsibilities will be
